...
public class HumanReadableInvalidException extends RuntimeException {
  private static final long serialVersionUID = -4086739455491882622L;
  private static final String HUMAN_READABLE_MISSING_MESSAGE =
      "Human readable bytes are missing for measure: %s";
  private static final String EXCEPTION_MESSAGE =
      "Cannot process Human readable for id: %s: xhtml: %s";
