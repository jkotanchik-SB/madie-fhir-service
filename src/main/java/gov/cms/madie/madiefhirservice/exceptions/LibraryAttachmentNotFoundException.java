...
public class LibraryAttachmentNotFoundException extends RuntimeException {
  private static final String NOT_FOUND_BY_TYPE =
      "Cannot find attachment type %s " + "for library name: %s, version: %s";

  private static final String NONE_FOUND =
      "Cannot find any attachment for library name: %s, version: %s";
